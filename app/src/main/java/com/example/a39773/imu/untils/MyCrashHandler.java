...
public class MyCrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getPath()+File.separator+"IMU"+ File.separator + "/crash/";
            ...
            LogUtils.e(TAG, "an error occured while writing file..." + e.toString());
        }
        return null;
    }
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            LogUtils.e(TAG, "an error occured when collect package info" + e.toString());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtils.e(TAG, "an error occured when collect crash info" + e.toString());
            }
        }
    }
